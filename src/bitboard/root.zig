...
var b_masks = std.EnumArray(misc.types.Square, misc.types.BitBoard).initFill(.nil);
var r_masks = std.EnumArray(misc.types.Square, misc.types.BitBoard).initFill(.nil);

var b_atk_tbl = std.EnumArray(misc.types.Square, [*]misc.types.BitBoard).initUndefined();
var r_atk_tbl = std.EnumArray(misc.types.Square, [*]misc.types.BitBoard).initUndefined();
var sliding_atk_tbl = std.mem.zeroes([88772]misc.types.BitBoard);
