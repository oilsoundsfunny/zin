...
const tunables = blk: {
    ...
    var tbl: [std.meta.fields(@TypeOf(zon)).len]Tunable = .{
        ...
        .{ .name = "corr_pawn_w", .value = 986, .c_end = 96.0 },
        .{ .name = "corr_minor_w", .value = 1006, .c_end = 96.0 },
        .{ .name = "corr_major_w", .value = 1149, .c_end = 96.0 },

        .{ .name = "corr_pawn_update_w", .value = 2379, .c_end = 192.0 },
        .{ .name = "corr_minor_update_w", .value = 2035, .c_end = 192.0 },
        .{ .name = "corr_major_update_w", .value = 1921, .c_end = 192.0 },
