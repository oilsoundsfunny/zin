...
const tunables = blk: {
    ...
    const inits: [fields.len]Tunable.Init = .{
        ...
        .{ .name = "lmr_noisy_non_improving",       .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_cutnode",             .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_noisy_ttm",           .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_found_pv",            .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_gave_check",          .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_is_checked",          .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_is_pv",               .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_was_pv",              .min = 0, .max = 3072, .c_end = 128.0 },
        .{ .name = "lmr_noisy_was_pv_non_fail_low", .min = 0, .max = 3072, .c_end = 128.0 },

        .{ .name = "lmr_quiet_non_improving",       .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_cutnode",             .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_noisy_ttm",           .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_found_pv",            .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_gave_check",          .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_is_checked",          .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_is_pv",               .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_was_pv",              .min = 0, .max = 4096, .c_end = 192.0 },
        .{ .name = "lmr_quiet_was_pv_non_fail_low", .min = 0, .max = 4096, .c_end = 192.0 },
