...
pub const tunables = [_]Tunable {
	...
	.{.name = "noisy_fp_max_depth", .value = 5, .min = 4, .max = 9, .c_end = 1.0},
	.{.name = "noisy_fp_margin0", .value = 4, .min = -100, .max = -200, .c_end = 10.0},
	.{.name = "noisy_fp_margin1", .value = 113, .min = 10, .max = 360, .c_end = 12.0},
	.{.name = "noisy_fp_hist_divisor", .value = 253, .min = 100, .max = 512, .c_end = 16.0},
