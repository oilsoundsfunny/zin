...
const tunables = blk: {
    ...
    const inis: [fields.len]Tunable.Init = .{
        .{ .name = "tm_time_mult", .min = 32, .max = 128, .c_end = 4.0 },
        .{ .name = "tm_incr_mult", .min = 256, .max = 1024, .c_end = 32.0 },
