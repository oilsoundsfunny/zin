...
const tunables = blk: {
    ...
    const inits: [fields.len]Tunable.Init = .{
        ...
        .{ .name = "corr_cont1_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        .{ .name = "corr_cont2_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        .{ .name = "corr_cont4_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        .{ .name = "corr_cont6_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        ...
        .{ .name = "corr_cont1_update_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        .{ .name = "corr_cont2_update_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        .{ .name = "corr_cont4_update_w",       .min = 0, .max = 4096, .c_end = 128.0 },
        .{ .name = "corr_cont6_update_w",       .min = 0, .max = 4096, .c_end = 128.0 },
